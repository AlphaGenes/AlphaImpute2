...
# nInd -> the total number of individual 
# nGen -> the number of generation
# nParents -> the number of parents per generation
# nLociAll -> the number of loci 
# nLociHD -> the number of sequencing sites 
# nLociLD -> the number of chip sites
# nChr -> the number f Chromosome
# genoError -> the error rate of genotyping 
# seqDepth -> the depth of sequencing 
